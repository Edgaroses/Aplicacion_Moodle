...
print "<FONT SIZE=5> Nombre seccion contenedora de las Pruebas: </FONT>"; 
print "<BR><FONT SIZE=5>  >".$var62." /id=".$idcurso." </FONT></BR>";
print "<br><FONT SIZE=6><a target='_blank' href='http://localhost/an/course/view.php?id=" . $idcurso  ."'>Ir a las Pruebas creadas</a></FONT></br>";
