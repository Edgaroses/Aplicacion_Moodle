...
//query para ingresar la pregunta
...
VALUES 
((select idcategoryquestion from mdlhj_question_relation where idcategorycourse=(select id from mdlhj_course where fullname='" .$Nombre. "' 
and category='" .$Categoria. "')),'','Pregunta Aleatoria','0','0','','0','1.0000000','0.0000000','random','1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP );";
...
if(mysqli_query($link,$sql22)){ 
       print "<br>La pregunta fue creada</br>"; 
    }else{ 
